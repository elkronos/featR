...
#' capped at the detected core count. featR never auto-detects a "use all
#' cores" default (CRAN limits checks to 2 cores, and grabbing every core is
#' hostile to users' machines).
#'
